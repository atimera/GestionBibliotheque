...
<section class="container">
    <div class="content">
        ...
        <form:form action="saveBookCopy" modelAttribute="copy" method="post">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <%-- select book optioins --%>
                        <form:select path="book.id">
                            <form:option value="null" label="--- Selectionner le livre --" />
        ...
        <p><a href="${pageContext.request.contextPath}/book/copies">Retour à la liste</a></p>
